...
const FloatingInput = React.forwardRef(function FloatingInput({ className, defaultValue, ...props }, ref) {
    return (
        <Input
            placeholder=" "
...
const FloatingLabel = React.forwardRef(function FloatingLabel({ className, ...props }, ref) {
    return (
        <Label
            className={cn(
...
const FloatingLabelInput = React.forwardRef(function FloatingLabelInput({ id, label, defaultValue, ...props }, ref) {
    return (
        <div className="relative">
            <FloatingInput ref={ref} id={id} defaultValue={defaultValue} {...props} />
